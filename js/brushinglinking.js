...
d3.csv("data/iris.csv").then((data) => {
    ...
    //Scatterplot 2 (show Sepal width on x-axis and Petal width on y-axis)
    {
        ...
        //Define a second brush (call it brush2)
        let brush2 = d3.brush()
            .extent([[0,0], [width + margin.left + margin.right, height + margin.top + margin.bottom]]);
        ...
        function updateChart2(brushEvent) {
            ...
            myCircles2.classed("selected", function(d){ is_selected = isBrushed(extent, x2(d.Sepal_Width), y2(d.Petal_Width));
                if(is_selected){
